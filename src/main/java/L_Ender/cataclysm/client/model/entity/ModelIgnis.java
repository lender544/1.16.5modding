...
public class ModelIgnis extends AdvancedEntityModel<Ignis_Entity> {
    ...
    public void animate(Ignis_Entity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.rotate(left_hand, (float)Math.toRadians(37.5F), (float)Math.toRadians(37.5F), (float)Math.toRadians(-15F));
        animator.endKeyframe();
        animator.setStaticKeyframe(20);
        animator.resetKeyframe(15);
    }
    ...
    @Override
    public void setRotationAngles(Ignis_Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
